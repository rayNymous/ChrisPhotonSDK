...
using UnityEngine;
    ...
    public class GameCharacter : WorldObject
    {
        ...
        public override void OnStart()
        {
            ...
            var combatTextCollection = FindObjectOfType<CombatTextCollection>();
            if (combatTextCollection != null)
            {
                ScrollingText = FindObjectOfType<CombatTextCollection>().CreateHudText(this.gameObject);
            }
        }
        ...
        public override void PrepareForDestruction()
        {
            ...
            Destroy(ScrollingText.gameObject);
        }
