...
internal class NetworkingPeer : LoadbalancingPeer, IPhotonPeerListener
{
    ...
    public IPhotonPeerListener CustomListener { get; set; }
    ...
    public void DebugReturn(DebugLevel level, string message)
    {
        ...
        {
            CustomListener.DebugReturn(level, message);
        }
    ...
    public void OnOperationResponse(OperationResponse operationResponse)
    {
        ...
        if (CustomListener != null)
        {
            CustomListener.OnOperationResponse(operationResponse);
        }
    ...
    public void OnStatusChanged(StatusCode statusCode)
    {
        ...
        if (CustomListener != null)
        {
            CustomListener.OnStatusChanged(statusCode);
        }
    }
    ...
    public void OnEvent(EventData photonEvent)
    {
        ...
        if (CustomListener != null)
        {
            CustomListener.OnEvent(photonEvent);
        }
    }
